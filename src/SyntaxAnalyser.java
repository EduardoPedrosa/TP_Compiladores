      ...
      if (iscurrenttoken(" int") || iscurrenttoken(" float") )                        // or float
      {
         if ( typespecifier("ID"))
         {
            ...
            { 
               ...
               codeGeneration[currentArrPostion][0]="atrib";
               codeGeneration[currentArrPostion][1]="0";
...
//---------------------------------------------------------------  
   ...
   {     int i=0;
      ...
      System.out.printf("%14s%11s%11s%11s%n", "Operations", "Op1", "Op2", "Result");
    /*  for (int i=0; i<codeGeneration.length;i++)
      ...
      {
         if (s[0] != null)
            System.out.printf("%3d%11s%11s%11s%11s%n", i, s[0], s[1], s[2], s[3]);
